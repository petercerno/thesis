...
\hypersetup{
    ...
    pdfkeywords={analysis by reduction, grammatical inference, restarting automata, string-rewriting systems, context rewriting systems},
    pdfnewwindow=true,
    colorlinks=false,
    linkcolor=red,
    citecolor=green,
...
string-rewriting systems, context rewriting systems.
