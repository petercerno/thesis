...
\newcommand\LNCS[1]{{\it LNCS #1}}
\newcommand\LNAI{{\it LNAI}}
\newcommand{\FI}{{\em Fund.~Inf.}}
\newcommand{\ICOM}{{\em Inform.~and Comput.}}
\newcommand{\IJFCS}{{\em Intern.~J.~Found.~Comput.~Sci.}}
\newcommand{\JACM}{{\em J.~Assoc.~Comput.~Mach.}}
\newcommand{\JALC}{{\em J.~Autom.~Lang.~Comb.}}
\newcommand{\JCSS}{{\em J.~Comput.~System~Sci.}}
\newcommand{\RAIRO}{{\em RAIRO-Inf.~Theor.~Appl.}}
\newcommand{\TCS}{{\em Theoret.~Comput.~Sci.}}
\newcommand{\ArchMLG}{{\em Arch.~f.~Math.~Logik Grundlagenf.}}

\newlength{\cwidth}

%\newcommand{\lcRA}{\mbox{\sf lc-RA\xspace}}
\newcommand{\lcRA}[1][]{\ifthenelse{\equal{#1}{}}{\mbox{\sf lc-RA}}{\mbox{\sf lc-RA$[\mathcal{R}_#1]$}}\xspace}
\newcommand{\lcRAp}[1][]{\ifthenelse{\equal{#1}{}}{\mbox{\sf lc-RA}}{\mbox{\sf lc-RA$[\mathcal{R}_#1']$}}\xspace}
\newcommand{\lcR}[1][]{\ifthenelse{\equal{#1}{}}{\mbox{\sf lc-R}}{\mbox{\sf lc-R$[\mathcal{R}_#1]$}}\xspace}
\newcommand{\lcRp}[1][]{\ifthenelse{\equal{#1}{}}{\mbox{\sf lc-R}}{\mbox{\sf lc-R$[\mathcal{R}_#1']$}}\xspace}
\newcommand{\conlcRA}[1][]{\mbox{\sf lc-RA$[\mbox{\sf con-}\mathcal{R}_#1]$}\xspace}
\newcommand{\conlcRAp}[1][]{\mbox{\sf lc-RA$[\mbox{\sf con-}\mathcal{R}_#1']$}\xspace}
\newcommand{\conlcR}[1][]{\mbox{\sf lc-R$[\mbox{\sf con-}\mathcal{R}_#1]$}\xspace}
\newcommand{\conlcRp}[1][]{\mbox{\sf lc-R$[\mbox{\sf con-}\mathcal{R}_#1']$}\xspace}
