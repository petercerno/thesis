...
{\rm (d)} & \Reg  & \subset & \textup{\sf con-mon-McNL} & \subseteq & 
\textup{\sf con-gen-mon-McNL}\; \subset\; \symDCFL.
\end{array}$
\end{theorem}
