...
\index{language!context-sensitive!acyclic|see{$\ACSL$}}
\index{language!context-sensitive!growing|see{$\GCSL$}}
\index{language!context-sensitive!growing acyclic|see{$\GACSL$}}
...
\index{minimally adequate teacher|see{MAT}}
...
\index{two-pushdown automaton|see{$\TPDA$}}